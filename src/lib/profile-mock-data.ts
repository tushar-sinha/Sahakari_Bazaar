...
const communityPostsRetailer: CommunityPost[] = [
  {
    ...
    image: "/images/categories/fruits-vegetables.svg",
...
const communityPostsService: CommunityPost[] = [
  {
    ...
    image: "/images/categories/home-kitchen.svg",
    timestamp: new Date("2024-04-27"),
    likes: 312,
    comments: 67,
  },
  ...
  },
  {
    ...
    image: "/images/categories/store.svg",
...
export const mockRetailerProfile: BusinessProfile = {
  ...
  coverImage: "/images/categories/fruits-vegetables.svg",
...
export const mockServiceProfile: BusinessProfile = {
  ...
  profileImage: "/images/categories/store.svg",
  coverImage: "/images/categories/home-kitchen.svg",
...
export const mockCreatorProfile: BusinessProfile = {
  ...
  profileImage: "/images/categories/store.svg",
  coverImage: "/images/categories/electronics-accessories.svg",
  location: "Delhi",
  city: "Delhi",
  state: "Delhi",
  pincode: "110001",
